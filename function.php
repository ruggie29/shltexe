...
function replayMsg ($tkn,$cId,$msgTxt,$msgId)
{
    $TelegramUrlSendMessage = "https://api.telegram.org/".$tkn."//sendMessage?chat_id=".$cId."&text=".urlencode($msgTxt)."&reply_to_message_id=".$msgId;
